...
echo "perl ${COMMAND_FUSION}/addComb2ID.pl ${OUTPUTDIR}/sequence/sequence.bam ${TARGETDIR}/comb2ID.txt 20 ${SAMTOOLS_PATH} > ${TARGETDIR}/comb2ID2.txt"
perl ${COMMAND_FUSION}/addComb2ID.pl ${OUTPUTDIR}/sequence/sequence.bam ${TARGETDIR}/comb2ID.txt 20 ${SAMTOOLS_PATH} > ${TARGETDIR}/comb2ID2.txt
check_error $?
